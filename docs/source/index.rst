...
*Karate Club* is an unsupervised machine learning extension library for `NetworkX <https://networkx.github.io/>`_. It builds on other open source linear algebra, machine learning, and graph signal processing libraries such as `Numpy <https://networkx.github.io/>`_, `Scipy <https://networkx.github.io/>`_, `Gensim <https://networkx.github.io/>`_, `PyGSP <https://networkx.github.io/>`_, and `Scikit-Learn <https://networkx.github.io/>`_. 
