...
* Annamalai Narayanan, Mahinthan Chandramohan, Rajasekar Venkatesan, Lihui Chen, Yang Liu, Shantanu Jaiswal: **graph2vec: Learning Distributed Representations of Graphs** `Paper <https://graphreason.github.io/papers/16.pdf>`_, `Code <https://github.com/benedekrozemberczki/graph2vec>`_
